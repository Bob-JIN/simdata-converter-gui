...
TRANSLATIONS = {
    'zh': {
        ...
        'split_failed': '拆分失败',
        'splitting_file': '正在拆分: {} ({}/{})',
        'hdf5_format': 'HDF5 Files (*.h5 *.hdf5)',
    },
    'en': {
    ...
    'fr': {
        ...
        'shuffle_num': 'Graîne aléatoire',
        'train_ratio': 'Ratio Entraînement',
        'test_ratio': 'Ratio Test',
        'valid_ratio': 'Ratio Validation',
        'split': 'Diviser',
        'split_started': 'Division démarrée',
        'split_completed': 'Division terminée',
        'split_failed': 'Échec de la division',
        'splitting_file': 'Division: {} ({}/{})',
        'hdf5_format': 'Fichiers HDF5 (*.h5 *.hdf5)',
    }
}
